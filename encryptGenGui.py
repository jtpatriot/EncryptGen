...
ttk.Label(mainframe, borderwidth=2, padding=4, relief=SUNKEN, \
textvariable=printStr).grid(column=2, row=5, sticky=(W, E, N))
ttk.Button(mainframe, text="Mode 1", command='').grid(column=2, \
row=1, sticky=(W, N))
ttk.Button(mainframe, text="Mode 2", command='').grid(column=2, \
row=1, sticky=(N))
ttk.Button(mainframe, text="Mode 3", command='').grid(column=2, \
row=1, sticky=(E, N))

ttk.Label(mainframe, textvariable=description).grid(column=2, row=2, sticky=NW)
ttk.Label(mainframe, text="Password:").grid(column=1, row=3, sticky=NW)
ttk.Label(mainframe, text="Status:").grid(column=1, row=4, sticky=NW)
